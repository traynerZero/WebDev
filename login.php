...
<body>
  <div>
    <div>
      <form action="home.php" method="post" class="form-login column">
      
        <h1>Login</h1>
        
        <fieldset>          
          <label for="mail">Email:</label>
          <input type="email" id="mail" name="user_email" autocomplete="false">
          
          <label for="password">Password:</label>
          <input type="password" id="password" name="user_password" autocomplete="false">
          
        <button type="submit" style="padding: 0;width: 100%;"><h2>Sign in</h2></button>
        <br>
        <br>
        <br>
        <a class="cursor" id="regBtn" style="color: white;">Don't have an account? Register</a>
      </form>
    </fieldset>
